...
delimiter ;;
CREATE FUNCTION `gdate`(`jy` smallint, `jm` smallint, `jd` smallint) RETURNS datetime DETERMINISTIC READS SQL DATA
BEGIN
...
delimiter ;;
CREATE FUNCTION `gdatestr`(`jdat` char(10)) RETURNS datetime DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2011-2012 Mehran . M . Spitman
# WebLog spitman.azdaa.com
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `pdate`(`gdate` datetime) RETURNS char(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
...
delimiter ;;
CREATE FUNCTION `pday`(`gdate` datetime) RETURNS char(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
...
delimiter ;;
CREATE FUNCTION `PMONTH`(`gdate` datetime) RETURNS char(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.2
...
delimiter ;;
CREATE FUNCTION `pmonthname`(`gdate` datetime) RETURNS varchar(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `pweekday`(`pdateinput` date) RETURNS varchar(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
...
delimiter ;;
CREATE FUNCTION `pyear`(`gdate` datetime) RETURNS char(100) CHARSET utf8mb4 DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `_gdmarray`(`m` smallint) RETURNS smallint(2) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `_gdmarray2`(`m` smallint, `k` SMALLINT) RETURNS smallint(2) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2011-2012  Mehran . M . Spitman
# WebLog :spitman.azdaa.com
# Version V1.0
...
delimiter ;;
CREATE FUNCTION `_jdmarray`(`m` smallint) RETURNS smallint(2) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `_jdmarray2`(`m` smallint) RETURNS smallint(2) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2011-2012 Mehran . M . Spitman
# WebLog :spitman.azdaa.com
# Version V1.0.1
...
delimiter ;;
CREATE FUNCTION `__mydiv`(`a` int, `b` int) RETURNS bigint(20) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2009-2012 Mohammad Saleh Souzanchi
# WebLog : www.saleh.soozanchi.ir
# Version V1.0.2
...
delimiter ;;
CREATE FUNCTION `__mymod`(`a` int, `b` int) RETURNS bigint(20) DETERMINISTIC READS SQL DATA
BEGIN
# Copyright (C) 2011-2012 Mehran . M . Spitman
# WebLog :spitman.azdaa.com
# Version V1.0.2
