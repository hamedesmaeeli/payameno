...
public class FarsiCalendarConversion {
     ...
     */
    public FarsiCalendarConversion() {
    ...
    public FarsiCalendarConversion(Date dateTime) {
        Calendar calendar = new GregorianCalendar();
     ...
     * @param day   int
     */
    public FarsiCalendarConversion(int year, int month, int day) {
    ...
    public String getIranianDate() {
        return (irYear + "/" + getDigit(irMonth) + "/" + getDigit(irDay));
    }
    ...
    public String getGregorianDate() {
        ...
        return (gYear + "/" + getDigit(gMonth) + "/" + getDigit(gDay));
    }
    ...
    public void setIranianDate(String date) {
        String[] datePart = date.split("/");
        try {
            setIranianDate(Integer.parseInt(datePart[0]), Integer.parseInt(datePart[1]), Integer.parseInt(datePart[2]));
    ...
    public void setGregorianDate(String date) {
        String[] datePart = date.split("/");
        try {
            setGregorianDate(Integer.parseInt(datePart[0]), Integer.parseInt(datePart[1]), Integer.parseInt(datePart[2]));
        } catch (NumberFormatException ex) {
            ex.printStackTrace();
...
//        logger.debug("Day of Year :" + DAY_OF_YEAR);
